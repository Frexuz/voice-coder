...
// Basic globals (both globalThis and global for compatibility)
// @ts-ignore
...
// @ts-ignore
global.requestAnimationFrame = win.requestAnimationFrame.bind(win) as any;
// @ts-ignore
globalThis.cancelAnimationFrame = win.cancelAnimationFrame.bind(win) as any;
// @ts-ignore
global.cancelAnimationFrame = win.cancelAnimationFrame.bind(win) as any;
