...
export default function Home() {
  ...
  // WebSocket setup (connect once on mount)
  useEffect(() => {
    ...
    <main className="flex flex-col justify-center items-center bg-gray-50 px-4 min-h-screen">
      <div className="space-y-6 w-full max-w-md">
        ...
        <div className="flex flex-col items-center space-y-2">
          {supportsSpeech ? (
            <button
              className={`user-select-none w-20 h-20 rounded-full bg-blue-600 text-white flex items-center justify-center text-4xl shadow-lg active:bg-blue-800 transition-all`}
